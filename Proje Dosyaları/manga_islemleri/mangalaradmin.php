<?php
    ...
    <table class="table table-dark table-bordered table-hover text-light my-4 table-striped">
        <thead class="thead-light">
            <tr>
                ...
                <th scope="col">Mangayı Sil</th>
            </tr>
        </thead>
    <tbody>';

    //while dongusu ile veri tabanindan cekilen veri bitene kadar mangalari ekrana yazdirir. 
    //mangalar.php'den tek farki ek olarak manga sil tusunu da tabloya ekler.
    while($row = mysqli_fetch_array($result)){
        echo "<tr>
                ...
                <td> " . $row['bitti'] . "</td>
                <td> <a class='btn btn-danger' href='mangasil.php?id=".$row['manga_id']."'>Delete</a> </td> 
            </tr>"; 
    }
